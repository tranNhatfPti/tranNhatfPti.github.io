                                ...
                                <div class="account_form">
                                    ...
                                    <form action="LoginServlet">
                                        <p>   
                                            ...
                                            <input type="text" name="username" placeholder="Username" value="${cookie.cUsername.value}" required>
                                        </p>
                                        <p>   
                                            <label>Password <span>*</span></label>
                                            <input type="password" name="password" placeholder="Password" value="${cookie.cPassword.value}" required>
                                        </p>   
                                        <p class="message_login">${requestScope.msFailLogin}</p>
                                        <div class="login_submit">
                                            <button type="submit">Login</button>
                                            <input type="hidden" name="service" value="login">
                                            <label for="remember">
                                                <input id="remember" type="checkbox" name="rememberMe" value="rememberMe">
                                                Remember me
                                            </label>
                                            <a href="lost-password.jsp" class="forget_pass_label">Lost password?</a>
                                            <p class="res" style="">if you are not registered -> <a href="register.jsp">Register</a></p>                                                  
                                        </div>
                                    </form>
                                </div>    
                            </div>
