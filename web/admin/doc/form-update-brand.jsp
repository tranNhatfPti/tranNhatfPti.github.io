...
<html lang="en">
    <head>
        <title>Sửa thương hiệu | Quản trị Admin</title>
        <meta charset="utf-8">
    ...
    <body class="app sidebar-mini rtl">
        ...
        <%
            ...
            Brand brandNeedUpdate = (Brand)request.getAttribute("brandNeedUpdate");
                        ...
                        <div class="tile-body">
                            <form action="/Project/BrandServlet" class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" name="brandName" value="<%=brandNeedUpdate.getBrandName()%>">
                                </div>

                                <div class="form-group col-md-6">
                                    <label class="control-label">Ảnh thương hiệu</label>
                                    <input class="form-control" type="text" name="image" placeholder="Link" value="<%=brandNeedUpdate.getPicture()!=null?brandNeedUpdate.getPicture():""%>">
                                </div>
                                <div style="margin-left: 15px">
                                    <%
                                        String msUpdateBrand = (String) request.getAttribute("msUpdateBrand");
                                        if(msUpdateBrand != null) {
                                    %>
                                    <h4 style="color: green"><%=msUpdateBrand%></h4>
                                    <%
                                        }
                                    %>
                                </div>
