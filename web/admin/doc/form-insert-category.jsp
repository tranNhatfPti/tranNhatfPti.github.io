...
<html lang="en">
    <head>
        <title>Thêm danh mục | Quản trị Admin</title>
        <meta charset="utf-8">
                    ...
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <form action="/Project/CategoryServlet" class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="control-label">Miêu tả danh mục</label>
                                    <input class="form-control" type="text" name="description">
                                </div>
                                <div style="margin-left: 15px">
                                    <%
                                        String msInsertCategory = (String) request.getAttribute("msInsertCategory");
                                        if(msInsertCategory != null) {
                                    %>
                                    <h4 style="color: green"><%=msInsertCategory%></h4>
                                    <%
                                        }
                                    %>
                                </div>
