...
<html lang="en">
    <head>
        <title>Thêm đơn vị vận chuyển | Quản trị Admin</title>
        <meta charset="utf-8">
    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Thêm đơn vị vận chuyển</h3>
                        <div class="tile-body">
                            <form action="/Project/ShipperServlet" class="row">
                                ...
                                <div style="margin-left: 15px">
                                    <%
                                        String msInsertShipper = (String) request.getAttribute("msInsertShipper");
                                        if(msInsertShipper != null) {
                                    %>
                                    <h4 style="color: green"><%=msInsertShipper%></h4>
                                    <%
                                        }
                                    %>
                                </div>
