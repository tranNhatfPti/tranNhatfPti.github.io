<%-- 
    Document   : report-manage
    Created on : Mar 18, 2024, 12:22:44 AM
    Author     : ASUS ZenBook
--%>
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item active" href=<%=fromServlet==null?"report-manage.jsp":"admin/doc/report-manage.jsp"%>><i
