...
<html lang="en">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item active" href=<%=fromServlet==null?"chat.jsp":"admin/doc/chat.jsp"%>><i
    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item active"><a href="#"><b>Tin nhắn khách hàng</b></a></li>
            </ul>
            <div id="clock"></div>
        </div>
        <div class="row">
