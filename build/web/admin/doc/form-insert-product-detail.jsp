...
<html lang="en">
    <head>
        <title>Thêm chi tiết sản phẩm | Quản trị Admin</title>
        <meta charset="utf-8">
                            ...
                            <form action="/Project/ProductDetailServlet" class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="productCode" class="form-control">
                                        <%
                                            Vector<Product> listCodeAndName = (Vector<Product>)request.getAttribute("listCodeAndName");
                                            for(Product p : listCodeAndName) {
                                        %>
                                ...
                                <div style="margin-left: 15px">
                                    <%
                                        String msInsertProductDetail = (String) request.getAttribute("msInsertProductDetail");
                                        if(msInsertProductDetail != null) {
                                    %>
                                    <h4 style="color: green"><%=msInsertProductDetail%></h4>
                                    <%
                                        }
                                    %>
                                </div>                                         
