<%-- 
    Document   : form-insert-product
    Created on : Mar 1, 2024, 12:34:16 AM
    Author     : ASUS ZenBook
--%>
                    ...
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="form-insert-brand.jsp"><i
                                            class="fas fa-folder-plus"></i> Thêm thương hiệu</a>
                                </div>
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="form-insert-category.jsp"><i
                                            class="fas fa-folder-plus"></i> Thêm danh mục</a>
                                </div>
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="form-insert-shipper.jsp"><i
                                            class="fas fa-folder-plus"></i> Thêm hãng vận chuyển</a>
                                </div>
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="form-insert-product-detail.jsp"><i
                                            class="fas fa-folder-plus"></i> Thêm hãng chi tiết sản phẩm</a>
                                </div>
                            </div>
                            <form class="row" action="/Project/ProductServlet">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" type="number" readonly="" value="0" name="quantitySold">
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div style="margin-left: 15px">
                                    <%
                                        String msInsertProduct = (String) request.getAttribute("msInsertProduct");
                                        if(msInsertProduct != null) {
                                    %>
                                    <h4 style="color: green"><%=msInsertProduct%></h4>
                                    <%
                                        }
                                    %>
                                </div>
