...
<html lang="en">
    <head>
        <title>Sửa đơn vị vận chuyển | Quản trị Admin</title>
        <meta charset="utf-8">
    ...
    <body class="app sidebar-mini rtl">
        ...
        <%
            ...
            Shipper shipperNeedUpdate = (Shipper)request.getAttribute("shipperNeedUpdate");
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Sửa đơn vị vận chuyển</a></li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Sửa đơn vị vận chuyển</h3>
                        <div class="tile-body">
                            <form action="/Project/ShipperServlet" class="row">
                                <div class="form-group col-md-6">
                                    <label class="control-label">Mã đơn vị vận chuyển</label>
                                    <input class="form-control" type="text" name="shipperID" value="<%=shipperNeedUpdate.getShipperID()%>" readonly="">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Số điện thoại</label>
                                    <input class="form-control" type="text" name="phone" value="<%=shipperNeedUpdate.getPhone()%>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Tên đơn vị vận chuyển</label>
                                    <input class="form-control" type="text" name="companyName" value="<%=shipperNeedUpdate.getCompanyName()%>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Quốc gia</label>
                                    <input class="form-control" type="text" name="country" value="<%=shipperNeedUpdate.getCountry()%>">
                                </div>
                                <div style="margin-left: 15px">
                                    <%
                                        String msUpdateShipper = (String) request.getAttribute("msUpdateShipper");
                                        if(msUpdateShipper != null) {
                                    %>
                                    <h4 style="color: green"><%=msUpdateShipper%></h4>
                                    <%
                                        }
                                    %>
                                </div>
                                ...
                                <a style="margin-left: 10px" class="btn btn-cancel" href="admin/doc/shipper-manage.jsp">Hủy bỏ</a>
                            </form>
                        </div>
                    </div>
                    </main>
