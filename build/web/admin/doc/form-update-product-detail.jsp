...
<%@page import="java.util.Vector, jakarta.servlet.http.HttpSession, model.Customer, dal.CustomerDAO, model.ProductDetail, dal.ProductDetailDAO, model.Product, dal.ProductDAO, model.Brand, dal.BrandDAO, java.text.DecimalFormat"%>
<!DOCTYPE html>
<html lang="en">
    <head>
        <title>Sửa chi tiết sản phẩm | Quản trị Admin</title>
        <meta charset="utf-8">
    ...
    <body class="app sidebar-mini rtl">
        ...
        <%
            ...
            ProductDetail productdetailNeedUpdate = (ProductDetail)request.getAttribute("productdetailNeedUpdate");
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <form action="/Project/ProductDetailServlet" class="row">
                                <div class="form-group col-md-6">
                                    <label class="control-label">Mã sản phẩm</label>
                                    <input class="form-control" type="number" name="productCode" value="<%=productdetailNeedUpdate.getProductCode()%>" readonly="">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Số lượng</label>
                                    <input class="form-control" type="number" name="quantity" value="<%=productdetailNeedUpdate.getQuantity()%>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Kích thước</label>
                                    <input class="form-control" type="text" name="size" value="<%=productdetailNeedUpdate.getSize()%>" readonly="">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Màu sắc</label>
                                    <input class="form-control" type="text" name="color" value="<%=productdetailNeedUpdate.getColor()%>" readonly="">
                                </div>
                                <div style="margin-left: 15px">
                                    <%
                                        String msUpdateProductDetail = (String) request.getAttribute("msUpdateProductDetail");
                                        if(msUpdateProductDetail != null) {
                                    %>
                                    <h4 style="color: green"><%=msUpdateProductDetail%></h4>
                                    <%
                                        }
                                    %>
                                </div>
                                ...
                                <a style="margin-left: 10px" class="btn btn-cancel" href="admin/doc/product-detail-manage.jsp">Hủy bỏ</a>
                            </form>
                        </div>
                    </div>
                    </main>
