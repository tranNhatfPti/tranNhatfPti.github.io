<%-- 
    Document   : login.jsp
    Created on : Jan 23, 2024, 6:57:13 PM
    Author     : ASUS ZenBook
--%>
                    ...
                    <div class="customer_login">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="account_form" style="margin-bottom: 80px;">
                                    <h2>Lost Password</h2>
                                    <form action="LoginServlet">
                                        ...
                                        <p class="message_login">${requestScope.msUsername}</p>
                                        <p>   
                                            <label>Phone number registered to account <span>*</span></label>
                                            <input type="text" name="phone" required>
                                        </p>
                                        <p class="message_login">${requestScope.msPhone}</p>
                                        <p>   
                                        ...
                                        <p class="message_login">${requestScope.msPassword}</p>
                                        <p class="message_login" style="color: green; font-weight: bold">${requestScope.msChangePassword}</p>
                                        <div class="login_submit" style="display: flex; justify-content: space-between;">
                                            <button type="submit" style="margin-top: 5px">Accept</button>
                                            <input type="hidden" name="service" value="lostPassword">                                           
                                            <p style="margin: 0">if you are not registered -> <a href="register.jsp">Register</a></p>                                                  
                                        </div>
                                    </form>
                                </div>    
                            </div>
